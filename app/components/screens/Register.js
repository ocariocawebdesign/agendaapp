  ...
  const onSubmit = data => {
    services
      ...
      .then(result => {
        ...
        Alert.alert(
          'Sucesso!',
          `Parabéns ${result.nome}, sua conta foi criada com sucesso!`,
        );
      })
      .catch(e => {
      ...
      <Card>
        ...
        <Card.Content>
          <View style={{marginBottom: 20}}>
            ...
            {errors.nome && (
              <Text style={{color: '#bb2124'}}>{errors.nome.message}</Text>
            )}
          </View>
          ...
          <View style={{marginBottom: 20}}>
            ...
            {errors.email && (
              <Text style={{color: '#bb2124'}}>{errors.email.message}</Text>
            )}
          </View>
          ...
          <View style={{marginBottom: 20}}>
            ...
            {errors.senha && (
              <Text style={{color: '#bb2124'}}>{errors.senha.message}</Text>
            )}
          </View>
